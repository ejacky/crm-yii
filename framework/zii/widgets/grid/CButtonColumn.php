...
class CButtonColumn extends CGridColumn
{
	...
	public $downloadButtonUrl='Yii::app()->controller->createUrl("download",array("id"=>$data->primaryKey))';
	/**
	 * @var array the HTML options for the view button tag.
	 */
	public $deleteButtonOptions=array('class'=>'delete');
	
	public $downloadButtonOptions=array('class'=>'download');
	/**
	...
	protected function initDefaultButtons()
	{
		...
		foreach(array('download', 'view','update','delete') as $id)
		{
			$button=array(
